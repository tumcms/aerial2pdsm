...
if __name__ == "__main__":
    ...
    parser.add_argument("-kpts", "--bounding_box_corners", required=True, type=str, help="List of all bounding boxes that should be considered. One image AND keypoint per line, two keypoints (== two lines) are needed for every bounding box. See example files for more information")
